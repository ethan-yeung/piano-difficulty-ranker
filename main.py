...
pieces = [
    ...
    Piece(id=17, tier="Late Inter / Early Adv", title="Fantaisie-Impromptu", composer="Chopin",
          technicality=7.0, musicality=5.5, rhythmic_complexity=5.5,
          endurance=4.5, ornamentation=3.0, overall=5.6),
    Piece(id=18, tier="Late Inter / Early Adv", title="Piano Sonata No. 14, 1st Mvt (Moonlight)", composer="Beethoven",
          technicality=4.0, musicality=9.0, rhythmic_complexity=2.5,
          endurance=4.0, ornamentation=1.0, overall=5.0),
    Piece(id=19, tier="Late Inter / Early Adv", title="Étude Op. 25 No. 2 in F minor (The Bees)", composer="Chopin",
          technicality=7.0, musicality=5.5, rhythmic_complexity=4.0,
          endurance=4.5, ornamentation=1.0, overall=5.1),
    Piece(id=20, tier="Late Inter / Early Adv", title="Pathétique Sonata, 1st Mvt", composer="Beethoven",
          technicality=6.0, musicality=8.0, rhythmic_complexity=3.5,
          endurance=6.0, ornamentation=2.5, overall=5.9),
    Piece(id=21, tier="Late Inter / Early Adv", title="Pathétique Sonata, 2nd Mvt", composer="Beethoven",
          technicality=4.0, musicality=7.0, rhythmic_complexity=3.0,
    ...
    Piece(id=23, tier="Advanced", title="Prelude in C# minor, Op. 3 No. 2", composer="Rachmaninoff",
          technicality=7.0, musicality=7.5, rhythmic_complexity=3.5,
          endurance=5.5, ornamentation=2.5, overall=6.0),
    Piece(id=24, tier="Advanced", title="Hungarian Dance No. 5", composer="Brahms",
          technicality=7.5, musicality=6.0, rhythmic_complexity=4.5,
          endurance=6.5, ornamentation=2.0, overall=5.9),
    Piece(id=25, tier="Advanced", title="Prelude in G minor, Op. 23 No. 5", composer="Rachmaninoff",
          technicality=7.5, musicality=7.5, rhythmic_complexity=5.0,
          endurance=8.0, ornamentation=1.0, overall=6.6),
    Piece(id=26, tier="Advanced", title="Étude Op. 25 No. 5 (Wrong Note)", composer="Chopin",
          technicality=7.0, musicality=8.0, rhythmic_complexity=5.0,
          endurance=4.0, ornamentation=3.0, overall=6.2),
    Piece(id=27, tier="Advanced", title="Étude Op. 10 No. 12 (Revolutionary)", composer="Chopin",
          technicality=8.0, musicality=7.5, rhythmic_complexity=6.0,
          endurance=7.0, ornamentation=2.0, overall=6.8),
    Piece(id=28, tier="Advanced", title="Piano Sonata No. 14, 3rd Mvt (Moonlight)", composer="Beethoven",
          technicality=7.5, musicality=8.0, rhythmic_complexity=4.5,
          endurance=7.0, ornamentation=2.0, overall=6.6),
    Piece(id=29, tier="Advanced", title="Erlkönig, S. 558 No. 4", composer="Schubert/Liszt",
          technicality=7.5, musicality=9.0, rhythmic_complexity=4.0,
          endurance=10.0, ornamentation=3.5, overall=7.4),
    Piece(id=30, tier="Advanced", title="Scherzo No. 1 in B minor, Op. 20", composer="Chopin",
          technicality=8.0, musicality=8.0, rhythmic_complexity=5.0,
          endurance=6.5, ornamentation=2.0, overall=6.7),
    Piece(id=31, tier="Advanced", title="Étude Op. 10 No. 5 (Black Keys)", composer="Chopin",
    ...
    Piece(id=32, tier="Advanced", title="Étude Op. 25 No. 12 (Ocean)", composer="Chopin",
          technicality=8.0, musicality=7.0, rhythmic_complexity=5.0,
    ...
    Piece(id=34, tier="Virtuoso", title="Hungarian Rhapsody No. 2 in C# minor", composer="Liszt",
          technicality=9.5, musicality=8.5, rhythmic_complexity=5.0,
          endurance=9.0, ornamentation=9.0, overall=8.4),
    Piece(id=35, tier="Virtuoso", title="Étude Op. 25 No. 11 (Winter Wind)", composer="Chopin",
          technicality=8.5, musicality=7.0, rhythmic_complexity=5.0,
          endurance=8.0, ornamentation=2.0, overall=6.8),
    Piece(id=36, tier="Virtuoso", title="Étude Op. 10 No. 4 (Torrent)", composer="Chopin",
          technicality=9.0, musicality=7.5, rhythmic_complexity=5.0,
          endurance=8.0, ornamentation=2.0, overall=7.1),
    Piece(id=37, tier="Virtuoso", title="La Campanella", composer="Liszt",
          technicality=9.0, musicality=8.0, rhythmic_complexity=5.5,
          endurance=7.5, ornamentation=7.0, overall=7.8),
    Piece(id=38, tier="Virtuoso", title="Hammerklavier Sonata, Op. 106", composer="Beethoven",
          technicality=10.0, musicality=10.0, rhythmic_complexity=8.0,
          endurance=10.0, ornamentation=3.0, overall=9.0),
    Piece(id=39, tier="Virtuoso", title="Réminiscences de Don Juan", composer="Liszt",
          technicality=10.0, musicality=10.0, rhythmic_complexity=9.0,
          endurance=9.5, ornamentation=3.0, overall=9.1),
